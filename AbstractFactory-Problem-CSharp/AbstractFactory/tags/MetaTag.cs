...
namespace org.htmlparser.tags
{
    ...
    public class MetaTag : Tag
    {
        public string HttpEquiv
        {
            ...
            set { this.httpEquiv = value; }
        }

        public string MetaContent
        {
            get { return metaTagContents; }
        }

        public string MetaTagName
        {
            get { return metaTagName; }
            set { this.metaTagName = value; }
        }

        public string MetaTagContents
        {
            set { this.metaTagContents = value; }
        }
