...
{
    public class DivScanner : CompositeTagScanner
    {
        ...
        private static string[] MATCH_STRING = new string[] {"DIV"};

        public DivScanner() : this("")
        {
        }

        public DivScanner(string filter) : base(filter, MATCH_STRING)
        {
        }
