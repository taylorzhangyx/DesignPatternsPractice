...
{
    public class HtmlScanner : CompositeTagScanner
    {
        ...
        private static string[] MATCH_STRING = new string[] {"HTML"};

        public HtmlScanner() : this("")
        {
        }

        public HtmlScanner(string filter) : base(filter, MATCH_STRING)
        {
        }
