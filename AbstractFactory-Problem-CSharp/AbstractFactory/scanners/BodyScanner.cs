...
using System;
using BodyTag = org.htmlparser.tags.BodyTag;
...
{
    /// <summary> Scans body tags.
    /// </summary>
    public class BodyScanner : CompositeTagScanner
    {
        ...
        private static readonly string[] MATCH_NAME = new string[] {"BODY"};
        private static readonly string[] ENDERS = new string[] {};
        private static readonly string[] END_TAG_ENDERS = new string[] {"HTML"};

        public BodyScanner() : this("")
        {
        }

        public BodyScanner(string filter) : base(filter, MATCH_NAME, ENDERS, END_TAG_ENDERS, false)
        {
        }
