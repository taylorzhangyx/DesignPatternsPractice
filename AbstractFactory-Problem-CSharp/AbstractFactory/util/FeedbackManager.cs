...
namespace org.htmlparser.util
{
    ...
    /// ParserFeedback interface. End users can use the default
    /// DefaultParserFeedback or may provide their own by calling
    ...
    {
        public static ParserFeedback ParserFeedback
        {
            set { callback = value; }
        }
        ...
        {
            callback = new DefaultParserFeedback();
        }
    }
}
