...
namespace IndustrialLogic.CreationMethod
{
    ...
    public class CapitalCalculationTests
    {
        ...
        public void TermLoanSamePayments()
        {
            ...
            Loan termLoan = Loan.CreateTermLoan(LOAN_AMOUNT, HIGH_RISK_RATING, maturity);
        ...
        public void RevolverNoPayments()
        {
            ...
            Loan revolver = Loan.CreateRevolverLoan(LOAN_AMOUNT, HIGH_RISK_RATING, Loan.NO_DATE, expiry);
        ...
        public void RCTLNoPaymentsAfterMaturity()
        {
            ...
            Loan revolvingCreditTermLoan =
                Loan.CreateRCTLoan(loanAmount, loanAmount, LOW_RISK_RATING, maturity, expiry);
